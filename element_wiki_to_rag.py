...
INPUT_DIR = Path("data/element_wiki_info")
OUTPUT_DIR = Path("data/element_wiki_rag")
...
def clean_extract(text):
    ...
    # Stop at typical trailing sections
    stop_markers = [
        "== References ==",
        "== External links ==",
        "== Bibliography ==",
...
def generate_md_units():
    for json_file in INPUT_DIR.glob("*.json"):
        ...
        md_content = (
            f"# {title}\n\n"
            f"Source: Wikipedia – Figure skating elements\n\n"
            f"{clean_text}"
        )
...
if __name__ == "__main__":
    print("Generating Element Markdown RAG units...")
    generate_md_units()
    print("Done.")