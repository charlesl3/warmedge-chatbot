...
DATA_ROOT = Path("data")
OUTPUT_DIR = DATA_ROOT / "element_wiki_info"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

CATEGORY_NAME = "Category:Figure skating elements"
...
def fetch_category_members(category_name):
    ...
    print(f"Total elements found: {len(members)}")
    return members
...
if __name__ == "__main__":
    print("Starting element wiki enrichment...")
